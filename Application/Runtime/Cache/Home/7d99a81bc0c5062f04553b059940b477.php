...
<!--轮播图-->
    <div class="login">
     <div class="wrap">
	    <ul class="breadcrumb breadcrumb__t" style="font-size: larger;"><a class="home" href="<?php echo U('Index/index');?>"  >Home</a>  / <a class="home" href="<?php echo U('Index/showList');?>">List</a>  / Article</ul>
