...
<div class="header-bottom">
    <div class="wrap">
       ...
       <div class="login">
				    ...
				    <div class="cont span_2_of_about">
				     ...
				     <div class="section group">
						<div class="col_1_of_about-box span_1_of_about-box">
						   <a class="popup-with-zoom-anim" href="#small-dialog3">  <span class="rollover"></span><img src="/taiquandao/Public/Home/images/a-img.jpg" title="continue" alt=""/></a>
						...
						<div class="col_1_of_about-box span_1_of_about-box">
						   <a class="popup-with-zoom-anim" href="#small-dialog3">  <span class="rollover"></span><img src="/taiquandao/Public/Home/images/a-img1.jpg" title="continue" alt=""/></a>
		                    <h4 class="m_7"><a href="#">consectetuer adipiscing</a></h4>
							 <p>Lorem ipsum dolor consectetur adipisicing elit, sed do eiusmod.</p>
					     </div>
						<div class="col_1_of_about-box span_1_of_about-box">
						   <a class="popup-with-zoom-anim" href="#small-dialog3">  <span class="rollover"></span><img src="/taiquandao/Public/Home/images/a-img2.jpg" title="continue" alt=""/></a>
		                    <h4 class="m_7"><a href="#">consectetuer adipiscing</a></h4>
							 <p>Lorem ipsum dolor consectetur adipisicing elit, sed do eiusmod.</p>
					     </div>
				        <div class="clear"></div> 
		...
		<script src="/taiquandao/Public/Home/js/jquery.magnific-popup.js" type="text/javascript"></script>
		<link href="/taiquandao/Public/Home/css/magnific-popup.css" rel="stylesheet" type="text/css">
		<script>
