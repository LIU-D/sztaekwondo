...
<div class="header-bottom">
    <div class="wrap">
       ...
       <div class="login">
          <div class="wrap">
				<ul class="breadcrumb breadcrumb__t" style="font-size: larger;"><a class="home" href="<?php echo U('Index/index');?>">Home</a>  / About</ul>
					 ...
					 <h3>Testimonials</h3>
					  <div class="testimonials ">
						...
						<blockquote class="testi-item_blockquote">
							<a href="#">我们来自河北民族师范学院，起源于承德避暑山庄。 
							我们来自河北民族师范学院，起源于承德避暑山庄。
							我们来自河北民族师范学院，起源于承德避暑山庄。</a>
							<div class="clear"></div>
						</blockquote>
							<small class="testi-meta"><span class="user">欢迎进入河北民族师范学院</span>,
							<span class="info">官网</span><br><a href="http://www.hbun.net/">http://www.hbun.net/</a></small></div>
					   </div>
					   <div class="testimonials ">
						<div class="testi-item">
						<blockquote class="testi-item_blockquote">
...
跆拳道在全世界的组织主要分为两个体系，分别为：国际跆拳道联盟（ITF）和世界跆拳道联盟（WTF）。奥运会采用的是WTF体系。
				        ...
				        <h5 class="m_6">社团成员介绍</h5>
				     <div class="section group">
						<!--<div class="col_1_of_about-box span_1_of_about-box">-->
						   <!--<a class="popup-with-zoom-anim" href="#small-dialog3">  <span class="rollover"></span><img src="/sztaekwondo/Public/Home/images/a-img.jpg" title="continue" alt=""/></a>-->
					     ...
					     <!--</div>-->
						<!--<div class="col_1_of_about-box span_1_of_about-box">-->
						   <!--<a class="popup-with-zoom-anim" href="#small-dialog3">  <span class="rollover"></span><img src="/sztaekwondo/Public/Home/images/a-img1.jpg" title="continue" alt=""/></a>-->
		                    <!--<h4 class="m_7"><a href="#">consectetuer adipiscing</a></h4>-->
							 <!--<p>Lorem ipsum dolor consectetur adipisicing elit, sed do eiusmod.</p>-->
					     <!--</div>-->
						 <?php if(is_array($member_list)): foreach($member_list as $key=>$v): ?><div class="col_1_of_about-box span_1_of_about-box">
								 <a class="popup-with-zoom-anim" href="#small-dialog3">  <span class="rollover"></span><img src="/sztaekwondo<?php echo ($v["img_logo"]); ?>" title="continue" alt=""/></a>
								 <h4 class="m_7"><a href="#"><?php echo ($v["img_title"]); ?></a></h4>
								 <!--<p>Lorem ipsum dolor consectetur adipisicing elit, sed do eiusmod.</p>-->
		...
		<script src="/sztaekwondo/Public/Home/js/jquery.magnific-popup.js" type="text/javascript"></script>
		<link href="/sztaekwondo/Public/Home/css/magnific-popup.css" rel="stylesheet" type="text/css">
		<script>
