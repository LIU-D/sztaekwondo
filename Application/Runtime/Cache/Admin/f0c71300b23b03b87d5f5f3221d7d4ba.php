...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo U('addaddOk');?>" enctype="multipart/form-data">
		<div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<input onClick="article_save_submit();" class="btn btn-primary radius" type="submit" value="保存并提交审核"></input>
...
$(function(){
	...
	var uploader = WebUploader.create({
		...
		// 文件接收服务端。
		server: '/Public/Admin/lib/webuploader/0.1.5/server/fileupload.php',
...
(function( $ ){
    ...
    $(function() {
        ...
        //             } else {
        //                 $.ajax('/Public/Admin/lib/webuploader/0.1.5/server/preview.php', {
        //                     method: 'POST',
        //                     data: src,
        //                     dataType:'json'
